package com.fireflymovie.tv.db;
...
import com.fireflymovie.tv.bean.Backup;
...
import com.fireflymovie.tv.db.dao.ConfigDao;
import com.fireflymovie.tv.db.dao.DeviceDao;
import com.fireflymovie.tv.db.dao.HistoryDao;
import com.fireflymovie.tv.db.dao.KeepDao;
import com.fireflymovie.tv.db.dao.LiveDao;
import com.fireflymovie.tv.db.dao.SiteDao;
import com.fireflymovie.tv.db.dao.TrackDao;
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static void backup() {
        backup(new com.fireflymovie.tv.impl.Callback());
    }

    public static void backup(com.fireflymovie.tv.impl.Callback callback) {
        Task.execute(() -> {
    ...
    public static void restore(File file, com.fireflymovie.tv.impl.Callback callback) {
        Task.execute(() -> {
