package com.fireflymovie.tv.player.exo;
...
import com.fireflymovie.tv.player.effect.audio.ExoAudioEffectController;
import com.fireflymovie.tv.player.effect.video.ExoVideoEffectController;
import com.fireflymovie.tv.player.effect.video.VideoEffectProfile;
import com.fireflymovie.tv.setting.VideoSetting;
...
public final class ExoPlayerEffect implements PlayerEffect {
    ...
    public boolean supportsVideoEffect() {
        // media3 fork 无 getVideoEffectsSupport()，保守假定支持（效果应用失败由 controller 容错）
        return true;
    }
    ...
    public void applyAudioEffect() {
        boolean support = !audioEffectFailed;
